...
def abrir_cadastro():
    ...
    cadastro.after(200, lambda: cadastro.attributes('-topmost', False))  
    ...
    ctk.CTkLabel(cadastro, text='E-mail:').pack(pady=(5, 10))
    entry_email = ctk.CTkEntry(cadastro)
    entry_email.pack()

    ctk.CTkLabel(cadastro, text='CPF:').pack(pady=(5, 10))
    entry_cpf = ctk.CTkEntry(cadastro)
    entry_cpf.pack()
    ...
    def salvar_dados():
        ...
        usuarios.append({'usuario': nome, 'senha': senha, 'e-mail': email, 'cpf': cpf})
